...
void loop() {
  ...
  if(lora_idle == true){
    delay(3890);  // Espera de 1500 ms entre envios
    ...
    sprintf(txpacket, "{\"id\":%d,\"temp\":%d,\"humidity\":%d,\"light\":%d,\"airQuality\":%d,\"pH\":%.1f,\"WindSpeed\":%d}", 
        id_ESP32,temp, humidity, light, airQuality, pH, WindSpeed);
